...
<?php
	...
	if(isset($_POST['cetak'])){
		header("Location:pdf/riwayatpdf.php") ;
	}
    ...
    if(isset($_GET['cari'])){
        ...
        $total_data = count(tampil("SELECT * FROM booking WHERE nama LIKE '%$cari%' ")) ;
        ...
        //tampilkan data
        $booking = tampil("SELECT * FROM booking WHERE nama LIKE '%$cari%' LIMIT $dataawal,$dataperhalaman ") ; 
    }

    //jika user tidak mencari data
    else{
        $total_data = count(tampil("SELECT * FROM booking")) ;
        $dataperhalaman = 5 ;
        $totalhalaman = ceil($total_data / $dataperhalaman) ;
        if(isset($_GET['hal'])){
            $halaktif = $_GET['hal'] ;
        ...
        $dataawal = ($halaktif * $dataperhalaman) - $dataperhalaman ; 
        $booking = tampil("SELECT * FROM booking LIMIT $dataawal,$dataperhalaman ") ;
    }
					   			...
					   			<div class="table-title">
					     			<div class="row">
						     			<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    			<h2 class="ml-lg-2">Kelola data riwayat booking</h2>
							 			</div>
