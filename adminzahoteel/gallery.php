...
<?php
	...
	$nomor = 1 ;
        ...
        $total_data = count(tampil("SELECT * FROM gallery")) ;
        $dataperhalaman = 5 ;
        ...
        $gallery = tampil("SELECT * FROM gallery LIMIT $dataawal,$dataperhalaman ") ;
					   			...
					   			<div class="table-title">
					     			<div class="row">
						     			<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    			<h2 class="ml-lg-2">Kelola Data gallery</h2>
							 			</div>
							 			<div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
							   				<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
							   					<i class="material-icons">&#xE147;</i>
							   					<span>Tambah Data gallery</span>
							   				</a>
							 			</div>
					    			</div>
					   			</div>
											...
											<!----edit-modal start--------->
												<div class="modal fade" tabindex="-1" id="editEmployeeModal<?= $h['id'] ; ?>" role="dialog">
													...
													<!-- tampilkan data yang akan diubah kedalam form  -->
														<?php
															$id = $h['id'] ;
															$galleryubah = tampil("SELECT * FROM gallery WHERE id = $id ")[0] ;
														?>
													<!-- end tampil data -->
													...
													<div class="modal-dialog" role="document">
			  											<div class="modal-content">
															...
															<form action="" method="post" enctype="multipart/form-data">
																	<input type="hidden" name="fotolama" value="<?= $galleryubah['foto'] ; ?>">
																	<input type="hidden" name="id" value="<?= $galleryubah['id'] ; ?>">
															<div class="modal-body">
				  												<div class="form-group">
					  												<label for="idhotel">Id Hotel</label>
					  												<input type="number" class="form-control" name="idhotel" id="idhotel" value="<?= $galleryubah['idhotel'] ;?>">
				  												</div>													
																<div class="form-group">
					...
					<!---- add modal form --------->
						...
						<div class="modal fade" tabindex="-1" id="addEmployeeModal" role="dialog">
  							<div class="modal-dialog" role="document">
    							<div class="modal-content">
      								<div class="modal-header">
        								<h5 class="modal-title">Tambah Data Gallery</h5>
        								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          									<span aria-hidden="true">&times;</span>
        								</button>
									</div>
